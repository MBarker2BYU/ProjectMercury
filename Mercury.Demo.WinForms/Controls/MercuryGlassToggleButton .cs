...
// ***********************************************************************
// <copyright file="MercuryGlassToggleButton.cs">
...
/// <summary>
/// Displays a custom glass-style toggle button.
/// </summary>
public sealed class MercuryGlassToggleButton : ButtonBase
{
    private const int HOVER_ALPHA_INCREASE = 26;
    private const int PRESSED_ALPHA_INCREASE = 51;
    private const int CHECKED_ALPHA_INCREASE = 65;
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="MercuryGlassToggleButton"/> class.
    /// </summary>
    public MercuryGlassToggleButton()
    {
        SetStyle(
    ...
    [Category("Behavior")]
    [DefaultValue(false)]
    [Description("Gets or sets whether the toggle button is checked.")]
    public bool Checked
    {
        get => m_Checked;
        set
    ...
    private void OnCheckedChanged(EventArgs eventArgs)
    {
