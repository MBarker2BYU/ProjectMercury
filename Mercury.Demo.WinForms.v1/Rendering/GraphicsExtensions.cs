...
namespace Mercury.Demo.WinForms.v1.Rendering;
...
public static class GraphicsExtensions
{
    ...
    public static void ClearBackground(this Graphics graphics, Rectangle bounds, Color clearColor)
    {
        if (graphics == null)
    ...
    /// <exception cref="ArgumentNullException">graphics</exception>
    public static void RenderBackground(this Graphics graphics, Rectangle bounds, Color backColor, int startFillAlpha, int endFillAlpha,
    ...
    public static void RenderBackground(this Graphics graphics, Rectangle bounds, Color backColor,
        CornerStyle cornerStyle, RenderedCorners renderedCorners, int cornerSize)
    {
        if (graphics == null)
            throw new ArgumentNullException(nameof(graphics));
    ...
    /// <param name="cornerSize">Size of the corner.</param>
    /// <exception cref="ArgumentNullException">graphics</exception>
    public static void RenderBorder(this Graphics graphics, Rectangle bounds, Color borderColor,
        int borderWidth, CornerStyle cornerStyle, RenderedCorners renderedCorners, int cornerSize)
    {
        if (graphics == null)
            throw new ArgumentNullException(nameof(graphics));
    ...
    public static void RenderText(this Graphics graphics, string text, Font font, Rectangle bounds, TextFormatFlags flags, Color color,  Color disabledColor, bool enabled = true)
    {
    ...
    public static TextFormatFlags ToTextFormatFlags(this ContentAlignment contentAlignment,
        TextFormatFlags textFormatFlags = TextFormatFlags.Default)
    {
        ...
        if (contentAlignment is ContentAlignment.MiddleCenter or ContentAlignment.TopCenter or ContentAlignment.BottomCenter)
        {
            flags |= TextFormatFlags.HorizontalCenter;
        }
        else if (contentAlignment is ContentAlignment.MiddleRight or ContentAlignment.TopRight or ContentAlignment.BottomRight)
        {
        ...
        // Vertical Alignment
        if (contentAlignment is ContentAlignment.TopLeft or ContentAlignment.TopCenter or ContentAlignment.TopRight)
        {
            flags |= TextFormatFlags.Top;
        }
        else if (contentAlignment is ContentAlignment.BottomLeft or ContentAlignment.BottomCenter or ContentAlignment.BottomRight)
        {
    ...
    public static void RenderLine(this Graphics graphics, Point startPoint, Point endPoint, Color color, float width = 1.0f)
    {
    ...
    private static GraphicsPath CreateBorderPath(RectangleF bounds, CornerStyle cornerStyle, RenderedCorners renderedCorners, int cornerSize)
    {
    ...
    private static void AddRoundedPath(GraphicsPath path, RectangleF bounds, float size,
    ...
    /// <param name="bottomRight">if set to <c>true</c> [bottom right].</param>
    /// <param name="bottomLeft">if set to <c>true</c> [bottom left].</param>
    private static void AddClippedPath(GraphicsPath path, RectangleF bounds, float size,
        bool topLeft, bool topRight, bool bottomRight, bool bottomLeft)
    {
        var left = bounds.Left;
        var top = bounds.Top;
    ...
    private static ColorBlend CreateGradientBlend(Color baseColor, int startFillAlpha, int endFillAlpha, Rectangle bounds)
    {
