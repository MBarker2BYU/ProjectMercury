...
/// <summary>
/// Class EnvelopeHeader. This class cannot be inherited.
...
internal sealed class EnvelopeHeader(KeyId envelopeId, DateTimeOffset timestamp, KeyId senderKeyId,
    KeyId recipientKeyId, AlgorithmId encryption, AlgorithmId signature,
    ReadOnlyMemory replayToken, Metadata? meta = null) : IEnvelopeHeader
{
    /// <summary>
    /// Gets the empty.
    /// </summary>
    /// <value>The empty.</value>
    public static IEnvelopeHeader Empty => new EnvelopeHeader(KeyId.Empty, DateTimeOffset.MinValue,
        KeyId.Empty, KeyId.Empty, AlgorithmId.Empty, AlgorithmId.Empty, ReadOnlyMemory.Empty);
